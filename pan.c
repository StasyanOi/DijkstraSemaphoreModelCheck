...
short src_ln0 [] = {
	  0,  68,  22,  23,  24,  21,  20,  45, 
	 44,  47,  49,  48,  43,  30,  31,  29, 
	 28,  53,  70,  71,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "./code/verify.pml", 1, 19 },
	{ "-", 20, 21 }
};
uchar reached0 [] = {
	  0,   0,   1,   0,   0,   1,   1,   1, 
...
#ifndef NOCLAIM
	case 7:	/* claim select */
		spin_c_typ[0] = 5; /* task5 */
		((P7 *)pptr(h))->c_cur[0] = 3;
		reached5[3]=1;
		spin_c_typ[1] = 4; /* task4 */
		((P7 *)pptr(h))->c_cur[1] = 6;
		reached4[6]=1;
		spin_c_typ[2] = 3; /* task3 */
		((P7 *)pptr(h))->c_cur[2] = 6;
		reached3[6]=1;
		spin_c_typ[3] = 2; /* task2 */
		((P7 *)pptr(h))->c_cur[3] = 3;
		reached2[3]=1;
		spin_c_typ[4] = 1; /* task1 */
		((P7 *)pptr(h))->c_cur[4] = 6;
		reached1[6]=1;
		((P7 *)pptr(h))->_t = 1;
		((P7 *)pptr(h))->_p = 6;
		((P7 *)pptr(h))->_n = 4; /* task1 */
		src_claim = src_ln1;
#ifndef BFS
...
iniglobals(int calling_pid)
{
		...
		now.processesInsideCriticalSection = 0;
		workCounter = 0;
	{	int l_in;
...
{	/* int i; */
	...
	printf("	int    processesInsideCriticalSection:	%d\n", now.processesInsideCriticalSection);
	{	int l_in;
		for (l_in = 0; l_in < 5; l_in++)
		{
